...
const CosmeticCard: React.FC<CosmeticCardProps> = ({ cosmetic, t, language }) => {
  const name = language === 'ar' ? cosmetic.SpecificNameAr : cosmetic.SpecificName;
  ...
  return (
    <div className="bg-light-card dark:bg-dark-card rounded-xl shadow-md overflow-hidden transition-all duration-300">
      <div className="p-4">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-grow min-w-0">
            ...
            <h2 className="text-base font-bold text-light-text dark:text-dark-text" dir={language === 'ar' ? 'rtl' : 'ltr'}>
              {name}
            </h2>
          </div>
        </div>
